...
public class SearchTests {
    ...
    public void  setUp() {
        ...
        bookArrayList.add(new Book("title1","Book name 01","Book genre","Book writer","Book publicity date","Book rating"));
        bookArrayList.add(new Book("title2","Book name 11","Drama","Joe2","2020-02-19","2"));
        bookArrayList.add(new Book("title3","Book name 21","Drama","Joe3","2020-03-19","3"));
        bookArrayList.add(new Book("title4","Book name 31","Drama","Joe4","2020-04-19","4"));
